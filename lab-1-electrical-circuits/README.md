...
### Objective 
Observe how resistance affects current flow and LED brightness.
...
### Objective 
Observe the behaviour of the LED with a switch. Also, what happens if the switch is connected in the opposite direction?
...
# Lab 1 Exercise 2: Transistor Switch Circuit
...
### Objective
Use the PWM generator and observe how the Duty Cycle and Frequency affect the perceived light from the LED strip.
...
### Reflections 
* **Duty Cycle Variations (f=90 Hz):** By keeping the frequency constant and varying the Duty Cycle (D), we control the "on-time" of the LED.
* **Frequency Varioation (D=0.5):** We observed the transition from visible blinking to a steady glow, known as Flicker Fusion Threshold.
