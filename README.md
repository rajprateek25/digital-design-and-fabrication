...
Welcome to the table of contents for the lab exercises performed as part of the Digital Design and Fabrication Module. Please refer to the specific documentation sections below:
...
| Lab 2 | **[Introduction to Adruino Uno](./lab-2-adruino-uno/README.md)**  | Integrating an Arduino Uno with an I2C LCD screen, a Real-Time Clock (RTC) module, a buzzer, and push buttons to design and program a functional, standalone digital alarm clock. | Khushil Dave
...
| Lab 7 | **[3D Printing](./lab-7-3d-printing/README.md)**  | Learning about designing in Onshape through Onshape provided training videos, and then designing a product for 3D printing which can be utilized in daily life.  | -
